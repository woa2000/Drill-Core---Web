...
export default function BoletimCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setInclinacao(initialValues.Inclinacao);
    setAzimute(initialValues.Azimute);
    setHorimetroIncial(initialValues.HorimetroIncial);
    setHorimetroFinal(initialValues.HorimetroFinal);
    setErrors({});
  };
  const validations = {
    Data: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Boletim(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BoletimCreateForm")}
      {...rest}
    >
      <TextField
        label="Data"
