...
export default function ProjetoCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setNomeProjeto(initialValues.NomeProjeto);
    setErrors({});
  };
  const validations = {
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Projeto(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ProjetoCreateForm")}
      {...rest}
    >
      <TextField
        label="Nome projeto"
