...
export default function ConsistenciaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setTipoSolo(initialValues.TipoSolo);
    setErrors({});
  };
  const validations = {
    TipoSolo: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Consistencia(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "ConsistenciaCreateForm")}
      {...rest}
    >
      <TextField
        label="Tipo solo"
